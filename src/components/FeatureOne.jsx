        ...
        <div className='feature-container'>
            ...
            <div className='feature-description'>
                ...
                <p className='feature-description-paragraph'>
                    We&#39;ve created TokSwap to help you make cross-chain swaps in just few clicks.
                    You'll be able to easily convert your coins from one blockchain to another, or
                    trade them for other cryptocurrencies and token.
                </p>
                <div className='btn-container'>

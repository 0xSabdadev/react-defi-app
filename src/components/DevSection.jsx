    ...
    return (
        <div className='dev-section-container'>
            <h1 className='dev-section-title'>
                Building CrossChain <span className='highlighted'>Together</span>
            </h1>
            <div className='dev-section-wrapper'>
                <div className='dev-section-text'>
                    <h2>API SDK</h2>
                    <p className='dev-section-description'>
                        Our goal is to provide a full ecosystem that makes it easy for developers
                        create and deploy cross-chain applications.
                    </p>
